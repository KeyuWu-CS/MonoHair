...
class BackBone(nn.Module):
    ...
    def __init__(self, in_feat, kernel=3):
        ...
        self.init_conv = ConvBlock(in_feat, 16, kernel=kernel, padding=kernel // 2, dropprob=0.0, use_res=False)

        self.layer1 = DownModule(16, 16, kernel=kernel)
        self.layer2 = DownModule(16, 32, kernel=kernel)
