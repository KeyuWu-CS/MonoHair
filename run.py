...
pyngp_path = r'E:\wukeyu\Instant-NGP\instant-ngp-new\instant-ngp\build'
...
def parse_args():
	...
	parser.add_argument("--marching_cubes_density_thresh", default=2.8, type=float, help="Sets the density threshold for marching cubes.")
	...
	parser.add_argument('--fov_axis',default=0,type=int)
...
if __name__ == "__main__":
	...
	if ref_transforms:
		testbed.fov_axis = args.fov_axis
		testbed.fov = ref_transforms["camera_angle_x"] * 180 / np.pi
		if not args.screenshot_frames:
			args.screenshot_frames = range(len(ref_transforms["frame"]))
		print(args.screenshot_frames)
		for idx in args.screenshot_frames:
			f = ref_transforms["frame"][int(idx)]
